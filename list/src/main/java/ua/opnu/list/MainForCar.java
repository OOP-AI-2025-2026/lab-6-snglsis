...
public class MainForCar {
    ...
    // Метод для красивого вывода результата сравнения
    private static void compareCars(Car c1, Car c2) {
        ...
        if (result > 0) {
            System.out.println("Первый автомобиль считается БОЛЬШЕ второго\n");
        } else if (result < 0) {
            System.out.println("Второй автомобиль считается БОЛЬШЕ первого\n");
        } else {
            System.out.println("Автомобили равны по параметрам\n");
        }
    }
}
